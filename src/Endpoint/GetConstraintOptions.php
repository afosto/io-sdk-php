...
class GetConstraintOptions extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7HttplugEndpoint
{
    ...
    {
        return '/odr/rules/options/constraints';
    }
     ...
     *
     * @return \Afosto\Sdk\Model\OdrRulesOptionsConstraintsGetResponse200|null
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Afosto\\Sdk\\Model\\OdrRulesOptionsConstraintsGetResponse200', 'json');
        }
        if (401 === $status) {
