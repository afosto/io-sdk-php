...
class OdrSessionCalculationAdjustment
{
    /**
     * @var string
     */
    ...
    /**
     * @var OdrSessionCalculationAdjustmentResult
     */
    protected $result;
    ...
    public function getResult(): ?OdrSessionCalculationAdjustmentResult
    {
        return $this->result;
    }

    public function setResult(?OdrSessionCalculationAdjustmentResult $result): self
    {
        $this->result = $result;
