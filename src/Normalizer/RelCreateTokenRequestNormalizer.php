...
class RelCreateTokenRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && 'Afosto\\Sdk\\Model\\RelCreateTokenRequest' === get_class($data);
    }
