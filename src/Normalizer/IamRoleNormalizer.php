...
class IamRoleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && 'Afosto\\Sdk\\Model\\IamRole' === get_class($data);
    }
