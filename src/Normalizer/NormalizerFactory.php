...
class NormalizerFactory
{
    public static function create()
    {
        ...
        $normalizers[] = new OdrCreateScheduleRequestNormalizer();
        $normalizers[] = new OdrUpdateScheduleRequestNormalizer();
        $normalizers[] = new OdrCreateWarehouseRequestNormalizer();
        $normalizers[] = new OdrUpdateWarehouseRequestNormalizer();
