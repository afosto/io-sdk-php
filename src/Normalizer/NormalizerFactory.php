...
class NormalizerFactory
{
    public static function create()
    {
        ...
        $normalizers[] = new OdrGetSessionPickupPointResponseItemOpeningsItemNormalizer();
        $normalizers[] = new OdrSelectSessionServicePointRequestNormalizer();
        $normalizers[] = new OdrSelectSessionServicePointRequestWindowNormalizer();
        $normalizers[] = new OdrSelectSessionServicePointRequestServicePointNormalizer();
        $normalizers[] = new OdrSelectSessionContactRequestNormalizer();
        $normalizers[] = new OdrGetSessionShippingMethodResponseNormalizer();
        $normalizers[] = new OdrGetSessionDeliveryWindowNormalizer();
        ...
        $normalizers[] = new OdrSessionsSecretAuthenticatePostResponse200Normalizer();
