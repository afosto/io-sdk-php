...
class NormalizerFactory
{
    public static function create()
    {
        ...
        $normalizers[] = new ContentSimpleQueryNormalizer();
        $normalizers[] = new ContentFilterNormalizer();
        $normalizers[] = new ContentSearchQueryNormalizer();
        $normalizers[] = new ContentSimpleSeachResponseNormalizer();
        $normalizers[] = new ContentSeachResponseNormalizer();
        $normalizers[] = new ContentSuggestResponseNormalizer();
        $normalizers[] = new ContentFacetNormalizer();
        $normalizers[] = new ContentBucketNormalizer();
        $normalizers[] = new ContentDocumentResponseNormalizer();
        $normalizers[] = new ContentSimpleDocumentResponseNormalizer();
        $normalizers[] = new ContentFieldNormalizer();
        $normalizers[] = new ContentSortNormalizer();
        $normalizers[] = new ContentDefinitionModelNormalizer();
        $normalizers[] = new ContentDefinitionNormalizer();
        $normalizers[] = new ContentPaginationNormalizer();
