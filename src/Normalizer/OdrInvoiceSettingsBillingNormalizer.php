...
class OdrInvoiceSettingsBillingNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Afosto\\Sdk\\Model\\OdrInvoiceSettingsBilling' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Afosto\\Sdk\\Model\\OdrInvoiceSettingsBilling' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Afosto\Sdk\Model\OdrInvoiceSettingsBilling();
        ...
        if (property_exists($data, 'vat') && null !== $data->{'vat'}) {
            $object->setVat($this->denormalizer->denormalize($data->{'vat'}, 'Afosto\\Sdk\\Model\\OdrInvoiceSettingsBillingVat', 'json', $context));
        }
