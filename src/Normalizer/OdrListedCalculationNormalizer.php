...
class OdrListedCalculationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Afosto\\Sdk\\Model\\OdrListedCalculation' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Afosto\\Sdk\\Model\\OdrListedCalculation' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Afosto\Sdk\Model\OdrListedCalculation();
        ...
        if (property_exists($data, 'order_ids') && null !== $data->{'order_ids'}) {
            $values_2 = [];
            foreach ($data->{'order_ids'} as $value_2) {
                $values_2[] = $value_2;
            }
            $object->setOrderIds($values_2);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getOrderIds()) {
            $values_2 = [];
            foreach ($object->getOrderIds() as $value_2) {
                $values_2[] = $value_2;
            }
            $data->{'order_ids'} = $values_2;
        }
