...
class OdrSessionCalculationAdjustmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Afosto\\Sdk\\Model\\OdrSessionCalculationAdjustment' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Afosto\\Sdk\\Model\\OdrSessionCalculationAdjustment' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Afosto\Sdk\Model\OdrSessionCalculationAdjustment();
        ...
        if (property_exists($data, 'result') && null !== $data->{'result'}) {
            $object->setResult($this->denormalizer->denormalize($data->{'result'}, 'Afosto\\Sdk\\Model\\OdrSessionCalculationAdjustmentResult', 'json', $context));
        }
