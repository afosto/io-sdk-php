...
class LcsShipmentDetailsAddressingFromNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Afosto\\Sdk\\Model\\LcsShipmentDetailsAddressingFrom';
    }

    public function supportsNormalization($data, $format = null)
    {
        return get_class($data) === 'Afosto\\Sdk\\Model\\LcsShipmentDetailsAddressingFrom';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Afosto\Sdk\Model\LcsShipmentDetailsAddressingFrom();
        ...
        if (property_exists($data, 'carrier') && $data->{'carrier'} !== null) {
            $object->setCarrier($this->denormalizer->denormalize($data->{'carrier'}, 'Afosto\\Sdk\\Model\\LcsShipmentDetailsAddressingFromCarrier', 'json', $context));
        }
