...
class OdrOrderSettingsShippingNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Afosto\\Sdk\\Model\\OdrOrderSettingsShipping' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Afosto\\Sdk\\Model\\OdrOrderSettingsShipping' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Afosto\Sdk\Model\OdrOrderSettingsShipping();
        ...
        if (property_exists($data, 'window') && null !== $data->{'window'}) {
            $object->setWindow($this->denormalizer->denormalize($data->{'window'}, 'Afosto\\Sdk\\Model\\OdrOrderSettingsShippingWindow', 'json', $context));
        }
