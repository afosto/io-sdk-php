...
class OdrScheduleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'exceptions') && $data->{'exceptions'} !== null) {
            $values_1 = [];
            foreach ($data->{'exceptions'} as $value_1) {
                $values_1[] = \DateTime::createFromFormat("Y-m-d\TH:i:sP", $value_1);
            }
            $object->setExceptions($values_1);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getExceptions()) {
            $values_1 = [];
            foreach ($object->getExceptions() as $value_1) {
                $values_1[] = $value_1->format("Y-m-d\TH:i:sP");
            }
            $data->{'exceptions'} = $values_1;
        }
