...
class OdrGroupRouteReferencesOrdersItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Afosto\\Sdk\\Model\\OdrGroupRouteReferencesOrdersItem' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Afosto\\Sdk\\Model\\OdrGroupRouteReferencesOrdersItem' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Afosto\Sdk\Model\OdrGroupRouteReferencesOrdersItem();
        ...
        if (property_exists($data, 'warehouse') && null !== $data->{'warehouse'}) {
            $object->setWarehouse($this->denormalizer->denormalize($data->{'warehouse'}, 'Afosto\\Sdk\\Model\\OdrGroupRouteReferencesOrdersItemWarehouse', 'json', $context));
        }
        if (property_exists($data, 'shipments') && null !== $data->{'shipments'}) {
            $values = [];
            foreach ($data->{'shipments'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Afosto\\Sdk\\Model\\OdrGroupRouteReferencesOrdersItemShipmentsItem', 'json', $context);
            }
