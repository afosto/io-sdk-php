...
class OdrSessionCalculationServiceAdjustmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Afosto\\Sdk\\Model\\OdrSessionCalculationServiceAdjustment' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Afosto\\Sdk\\Model\\OdrSessionCalculationServiceAdjustment' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Afosto\Sdk\Model\OdrSessionCalculationServiceAdjustment();
        ...
        if (property_exists($data, 'result') && null !== $data->{'result'}) {
            $object->setResult($this->denormalizer->denormalize($data->{'result'}, 'Afosto\\Sdk\\Model\\OdrSessionCalculationServiceAdjustmentResult', 'json', $context));
        }
