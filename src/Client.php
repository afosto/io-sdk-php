...
class Client extends \Jane\OpenApiRuntime\Client\Psr7HttplugClient
{
     ...
     *
     * @return \Afosto\Sdk\Model\OdrGroupAttach[]|\Psr\Http\Message\ResponseInterface|null
     */
    public function searchGroupsWithAttach(\Afosto\Sdk\Model\OdrSearchOrdersItemsAttachPostBody $body, array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executePsr7Endpoint(new \Afosto\Sdk\Endpoint\SearchGroupsWithAttach($body, $headerParameters), $fetch);
    }
     ...
     */
    public function getBatches(array $queryParameters = [], array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executePsr7Endpoint(new \Afosto\Sdk\Endpoint\GetBatches($queryParameters, $headerParameters), $fetch);
    }
     ...
     * @return \Afosto\Sdk\Model\OdrMethod|\Psr\Http\Message\ResponseInterface|null
     */
    public function getPaymentMethod(string $providerCode, string $code, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executePsr7Endpoint(new \Afosto\Sdk\Endpoint\GetPaymentMethod($providerCode, $code), $fetch);
    }
    ...
    {
        return $this->executePsr7Endpoint(new \Afosto\Sdk\Endpoint\AddAvailableSkuToLocation($id, $body), $fetch);
    }
